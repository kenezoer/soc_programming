...
module miet_dw_axi_ic_DW_axi_dfltslv(
    // Inputs - System
    aclk_i,                  
    aresetn_i,               
  ...
  input [`miet_dw_axi_ic_AXI_BLW-1:0]  arlen_i;         // Burst Length
  //spyglass disable_block W240
  //SMD: An input has been declared but is not read
  //SJ: These ports are not used 
  input [`miet_dw_axi_ic_AXI_AW-1:0]  araddr_i;
  input [`miet_dw_axi_ic_AXI_BSW-1:0]  arsize_i;
  input [`miet_dw_axi_ic_AXI_LTW-1:0]  arlock_i;
  input [`miet_dw_axi_ic_AXI_BTW-1:0]  arburst_i;
  input [`miet_dw_axi_ic_AXI_CTW-1:0]  arcache_i;
  input [`miet_dw_axi_ic_AXI_PTW-1:0]  arprot_i;
  ...
  output [`miet_dw_axi_ic_AXI_RRW-1:0]   rresp_o;     // Read response
  output [`miet_dw_axi_ic_AXI_DW-1:0]    rdata_o;     // Read data
  ...
  input [`miet_dw_axi_ic_AXI_BLW-1:0] awlen_i;           // Burst length
  input [`miet_dw_axi_ic_AXI_AW-1:0]  awaddr_i;
  input [`miet_dw_axi_ic_AXI_BSW-1:0] awsize_i;
  input [`miet_dw_axi_ic_AXI_LTW-1:0] awlock_i;
  input [`miet_dw_axi_ic_AXI_BTW-1:0] awburst_i;
  input [`miet_dw_axi_ic_AXI_CTW-1:0] awcache_i;
  input [`miet_dw_axi_ic_AXI_PTW-1:0] awprot_i;
  //spyglass enable_block W240
  ...
  //SMD: An input has been declared but is not read
  //SJ: These ports are not used 
  input [`miet_dw_axi_ic_AXI_DW-1:0]    wdata_i;         // Write data 
  input [`miet_dw_axi_ic_AXI_SW-1:0]    wstrb_i;         // Write strobes
  //spyglass enable_block W240
  ...
  output [`miet_dw_axi_ic_AXI_BRW-1:0]   bresp_o;     // Write response
  ...
  reg [`miet_dw_axi_ic_AXI_BLW-1:0] arlen_r;  // Burst Length
  ...
  begin : arlen_r_PROC 
    if (!aresetn_i)
      arlen_r <= {`miet_dw_axi_ic_AXI_BLW{1'b0}};
    else
  ...
  // decode errors.
  assign rdata_o     = {`miet_dw_axi_ic_AXI_DW{1'b0}};
  assign rresp_o     = `miet_dw_axi_ic_AXI_RESP_DECERR;    
  ...
  // a decode error.
  assign bresp_o = `miet_dw_axi_ic_AXI_RESP_DECERR;  
