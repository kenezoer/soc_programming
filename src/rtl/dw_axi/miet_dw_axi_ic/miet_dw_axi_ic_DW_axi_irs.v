...
module miet_dw_axi_ic_DW_axi_irs (
  // Inputs - System.
  aclk_i,
  aresetn_i,
...
//----------------------------------------------------------------------
  ...
  parameter PYLD_W = `miet_dw_axi_ic_AXI_AR_PYLD_M_W; // Width of payload signals in 
                                       // this block.    
...
//----------------------------------------------------------------------
  ...
  //--------------------------------------------------------------------
  assign bus_valid_o = (TMO==`miet_dw_axi_ic_AXI_TMO_COMB)
                       ? bus_valid_i : 
                         ((TMO==`miet_dw_axi_ic_AXI_TMO_FRWD) 
                          ? frwd_bus_valid_mskd
                          : full_valid_mux
                         ); 

  assign payload_o = (TMO==`miet_dw_axi_ic_AXI_TMO_COMB)
                       ? payload_i : 
                         ((TMO==`miet_dw_axi_ic_AXI_TMO_FRWD) 
                           ? frwd_payload_r 
                           : full_payload_mux
  ...
  assign shrd_ch_req_o = SHARED_VIS
                         ?  ((TMO==`miet_dw_axi_ic_AXI_TMO_COMB)
                             ? shrd_ch_req_i : 
                               ((TMO==`miet_dw_axi_ic_AXI_TMO_FRWD) 
  ...
  assign ready_o = (TMO==`miet_dw_axi_ic_AXI_TMO_COMB)
                     ? ready_i : 
                       ((TMO==`miet_dw_axi_ic_AXI_TMO_FRWD) 
                         ? frwd_ready_o 
                         : full_ready
  ...
  assign id_o = (DO_MASKING & (TMO!=`miet_dw_axi_ic_AXI_TMO_COMB))
                ? ((TMO==`miet_dw_axi_ic_AXI_TMO_FRWD)
                    ? frwd_id
                    : full_id
                  )
  ...
  assign local_slv_o = (DO_MASKING & (TMO!=`miet_dw_axi_ic_AXI_TMO_COMB))
                       ? ((TMO==`miet_dw_axi_ic_AXI_TMO_FRWD)
                           ? frwd_local_slv
                           : full_local_slv
                         )
