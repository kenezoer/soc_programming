...
module miet_dw_axi_ic_DW_axi_systolcl (
  // Inputs.
  sys_pnum_i,
...
//----------------------------------------------------------------------
  ...
  // configurations.
  output [`miet_dw_axi_ic_AXI_MAX_NUM_USR_MSTS-1:0] bidi_sys_pnum_oh_o;
  ...
  wire [`miet_dw_axi_ic_AXI_MAX_NUM_MST_SLVS-1:0] bus_p_vis; // Bus containing all
                                              // port visibility 
                                              // parameters.
  ...
  wire [`miet_dw_axi_ic_AXI_MAX_NUM_USR_MSTS-1:0] bidi_mp_dec_bus;
  ...
  wire [SYSPNUM_W*`miet_dw_axi_ic_AXI_NUM_MST_THRU_ICM1-1:0] sys_msts_icm1;
  wire [SYSPNUM_W*`miet_dw_axi_ic_AXI_NUM_MST_THRU_ICM2-1:0] sys_msts_icm2;
  wire [SYSPNUM_W*`miet_dw_axi_ic_AXI_NUM_MST_THRU_ICM3-1:0] sys_msts_icm3;
  wire [SYSPNUM_W*`miet_dw_axi_ic_AXI_NUM_MST_THRU_ICM4-1:0] sys_msts_icm4;
  wire    dummy_wire  ;
  ...
  // SJ : This is not a functional issue, this is as per the requirement.
  //      Hence this can be waived.
  assign msts1_thru_icm1 = (`miet_dw_axi_ic_AXI_ALLOW_MST1_ICM1-1);
  assign msts2_thru_icm1 = (`miet_dw_axi_ic_AXI_ALLOW_MST2_ICM1-1);
  assign msts3_thru_icm1 = (`miet_dw_axi_ic_AXI_ALLOW_MST3_ICM1-1);
  assign msts4_thru_icm1 = (`miet_dw_axi_ic_AXI_ALLOW_MST4_ICM1-1);
  assign msts5_thru_icm1 = (`miet_dw_axi_ic_AXI_ALLOW_MST5_ICM1-1);
  assign msts6_thru_icm1 = (`miet_dw_axi_ic_AXI_ALLOW_MST6_ICM1-1);
  assign msts7_thru_icm1 = (`miet_dw_axi_ic_AXI_ALLOW_MST7_ICM1-1);
  assign msts8_thru_icm1 = (`miet_dw_axi_ic_AXI_ALLOW_MST8_ICM1-1);
  
  assign msts1_thru_icm2 = (`miet_dw_axi_ic_AXI_ALLOW_MST1_ICM2-1);
  assign msts2_thru_icm2 = (`miet_dw_axi_ic_AXI_ALLOW_MST2_ICM2-1);
  assign msts3_thru_icm2 = (`miet_dw_axi_ic_AXI_ALLOW_MST3_ICM2-1);
  assign msts4_thru_icm2 = (`miet_dw_axi_ic_AXI_ALLOW_MST4_ICM2-1);
  assign msts5_thru_icm2 = (`miet_dw_axi_ic_AXI_ALLOW_MST5_ICM2-1);
  assign msts6_thru_icm2 = (`miet_dw_axi_ic_AXI_ALLOW_MST6_ICM2-1);
  assign msts7_thru_icm2 = (`miet_dw_axi_ic_AXI_ALLOW_MST7_ICM2-1);
  assign msts8_thru_icm2 = (`miet_dw_axi_ic_AXI_ALLOW_MST8_ICM2-1);

  assign msts1_thru_icm3 = (`miet_dw_axi_ic_AXI_ALLOW_MST1_ICM3-1);
  assign msts2_thru_icm3 = (`miet_dw_axi_ic_AXI_ALLOW_MST2_ICM3-1);
  assign msts3_thru_icm3 = (`miet_dw_axi_ic_AXI_ALLOW_MST3_ICM3-1);
  assign msts4_thru_icm3 = (`miet_dw_axi_ic_AXI_ALLOW_MST4_ICM3-1);
  assign msts5_thru_icm3 = (`miet_dw_axi_ic_AXI_ALLOW_MST5_ICM3-1);
  assign msts6_thru_icm3 = (`miet_dw_axi_ic_AXI_ALLOW_MST6_ICM3-1);
  assign msts7_thru_icm3 = (`miet_dw_axi_ic_AXI_ALLOW_MST7_ICM3-1);
  assign msts8_thru_icm3 = (`miet_dw_axi_ic_AXI_ALLOW_MST8_ICM3-1);

  assign msts1_thru_icm4 = (`miet_dw_axi_ic_AXI_ALLOW_MST1_ICM4-1);
  assign msts2_thru_icm4 = (`miet_dw_axi_ic_AXI_ALLOW_MST2_ICM4-1);
  assign msts3_thru_icm4 = (`miet_dw_axi_ic_AXI_ALLOW_MST3_ICM4-1);
  assign msts4_thru_icm4 = (`miet_dw_axi_ic_AXI_ALLOW_MST4_ICM4-1);
  assign msts5_thru_icm4 = (`miet_dw_axi_ic_AXI_ALLOW_MST5_ICM4-1);
  assign msts6_thru_icm4 = (`miet_dw_axi_ic_AXI_ALLOW_MST6_ICM4-1);
  assign msts7_thru_icm4 = (`miet_dw_axi_ic_AXI_ALLOW_MST7_ICM4-1);
  assign msts8_thru_icm4 = (`miet_dw_axi_ic_AXI_ALLOW_MST8_ICM4-1);
...
//  The logic for bidi_mp1_dec is changed becoz of Lint Error
  ...
  begin : bidi_mp2_dec_PROC
    ...
    bidi_mp2_dec = 1'b0;
    if(((`miet_dw_axi_ic_AXI_SYS_NUM_FOR_M2-1) == sys_pnum_i) & p1_vis) begin
      bidi_mp2_dec = 1'b1;
    end
  ...
  begin : bidi_mp3_dec_PROC
    ...
    bidi_mp3_dec = 1'b0;
    if(((`miet_dw_axi_ic_AXI_SYS_NUM_FOR_M3-1)== sys_pnum_i) & p2_vis) begin
      bidi_mp3_dec = 1'b1;
    end
  end // bidi_mp1_dec_PROC
  ...
  begin : bidi_mp4_dec_PROC
    ...
    bidi_mp4_dec = 1'b0;
    if(((`miet_dw_axi_ic_AXI_SYS_NUM_FOR_M4-1) == sys_pnum_i) & p3_vis) begin
      bidi_mp4_dec = 1'b1;
    end
  end // bidi_mp1_dec_PROC
  ...
  // are being targeted.
  assign bidi_mp5_dec = p4_vis & ((`miet_dw_axi_ic_AXI_SYS_NUM_FOR_M5-1) == sys_pnum_i);
  assign bidi_mp6_dec = p5_vis & ((`miet_dw_axi_ic_AXI_SYS_NUM_FOR_M6-1) == sys_pnum_i);
  assign bidi_mp7_dec = p6_vis & ((`miet_dw_axi_ic_AXI_SYS_NUM_FOR_M7-1) == sys_pnum_i);
  assign bidi_mp8_dec = p7_vis & ((`miet_dw_axi_ic_AXI_SYS_NUM_FOR_M8-1) == sys_pnum_i);
  assign bidi_mp9_dec = p8_vis & ((`miet_dw_axi_ic_AXI_SYS_NUM_FOR_M9-1) == sys_pnum_i);
  assign bidi_mp10_dec = p9_vis & ((`miet_dw_axi_ic_AXI_SYS_NUM_FOR_M10-1) == sys_pnum_i);
  assign bidi_mp11_dec = p10_vis & ((`miet_dw_axi_ic_AXI_SYS_NUM_FOR_M11-1) == sys_pnum_i);
  assign bidi_mp12_dec = p11_vis & ((`miet_dw_axi_ic_AXI_SYS_NUM_FOR_M12-1) == sys_pnum_i);
  assign bidi_mp13_dec = p12_vis & ((`miet_dw_axi_ic_AXI_SYS_NUM_FOR_M13-1) == sys_pnum_i);
  assign bidi_mp14_dec = p13_vis & ((`miet_dw_axi_ic_AXI_SYS_NUM_FOR_M14-1) == sys_pnum_i);
  assign bidi_mp15_dec = p14_vis & ((`miet_dw_axi_ic_AXI_SYS_NUM_FOR_M15-1) == sys_pnum_i);
  assign bidi_mp16_dec = p15_vis & ((`miet_dw_axi_ic_AXI_SYS_NUM_FOR_M16-1) == sys_pnum_i);
