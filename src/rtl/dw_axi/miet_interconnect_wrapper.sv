...
module miet_interconnect_wrapper(
    ...
    miet_dw_axi(
        ...
        .AXI4_S3_SRAM_arready           ( AXI4_SRAM.ar_ready    ),
        .AXI4_S3_SRAM_awready           ( AXI4_SRAM.aw_ready    ),
        .AXI4_S3_SRAM_bid               ( AXI4_SRAM.b_id        ),
        .AXI4_S3_SRAM_bresp             ( AXI4_SRAM.b_resp      ),
        .AXI4_S3_SRAM_bvalid            ( AXI4_SRAM.b_valid     ),
        .AXI4_S3_SRAM_rdata             ( AXI4_SRAM.r_data      ),
        .AXI4_S3_SRAM_rid               ( AXI4_SRAM.r_id        ),
        .AXI4_S3_SRAM_rlast             ( AXI4_SRAM.r_last      ),
        .AXI4_S3_SRAM_rresp             ( AXI4_SRAM.r_resp      ),
        .AXI4_S3_SRAM_rvalid            ( AXI4_SRAM.r_valid     ),
        .AXI4_S3_SRAM_wready            ( AXI4_SRAM.w_ready     ),
        .AXI4_S3_SRAM_araddr            ( AXI4_SRAM.ar_addr     ),
        .AXI4_S3_SRAM_arburst           ( AXI4_SRAM.ar_burst    ),
        .AXI4_S3_SRAM_arcache           ( AXI4_SRAM.ar_cache    ),
        .AXI4_S3_SRAM_arid              ( AXI4_SRAM.ar_id       ),
        .AXI4_S3_SRAM_arlen             ( AXI4_SRAM.ar_len      ),
        .AXI4_S3_SRAM_arlock            ( AXI4_SRAM.ar_lock     ),
        .AXI4_S3_SRAM_arprot            ( AXI4_SRAM.ar_prot     ),
        .AXI4_S3_SRAM_arsize            ( AXI4_SRAM.ar_size     ),
        .AXI4_S3_SRAM_arvalid           ( AXI4_SRAM.ar_valid    ),
        .AXI4_S3_SRAM_awaddr            ( AXI4_SRAM.aw_addr     ),
        .AXI4_S3_SRAM_awburst           ( AXI4_SRAM.aw_burst    ),
        .AXI4_S3_SRAM_awcache           ( AXI4_SRAM.aw_cache    ),
        .AXI4_S3_SRAM_awid              ( AXI4_SRAM.aw_id       ),
        .AXI4_S3_SRAM_awlen             ( AXI4_SRAM.aw_len      ),
        .AXI4_S3_SRAM_awlock            ( AXI4_SRAM.aw_lock     ),
        .AXI4_S3_SRAM_awprot            ( AXI4_SRAM.aw_prot     ),
        .AXI4_S3_SRAM_awsize            ( AXI4_SRAM.aw_size     ),
        .AXI4_S3_SRAM_awvalid           ( AXI4_SRAM.aw_valid    ),
        .AXI4_S3_SRAM_bready            ( AXI4_SRAM.b_ready     ),
        .AXI4_S3_SRAM_rready            ( AXI4_SRAM.r_ready     ),
        .AXI4_S3_SRAM_wdata             ( AXI4_SRAM.w_data      ),
        .AXI4_S3_SRAM_wlast             ( AXI4_SRAM.w_last      ),
        .AXI4_S3_SRAM_wstrb             ( AXI4_SRAM.w_strb      ),
        .AXI4_S3_SRAM_wvalid            ( AXI4_SRAM.w_valid     ),
