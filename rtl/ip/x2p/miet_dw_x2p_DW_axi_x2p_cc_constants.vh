...
`define X2P_ALLOW_SPARSE_TRANSFER 1
...
`define X2P_WRITE_BUFFER_DEPTH 1
...
// allowed in only single-clock mode.
`define X2P_WRITE_RESP_BUFFER_DEPTH 1
...
`define X2P_READ_BUFFER_DEPTH 1
...
`define X2P_START_PADDR_S0 64'h0000000000010000
...
`define X2P_END_PADDR_S0 64'h0000000000010fff
...
`define X2P_START_PADDR_S1 64'h0000000000011000
...
// Dependencies: Any address must not be contained in any other range and 
// must have a minimum size of 1 KB, and must be aligned to a 1 KB boundary.
`define X2P_END_PADDR_S1 64'h0000000000011fff
...
`define X2P_AXI_START_ADDR 64'h10000


`define X2P_AXI_END_ADDR 64'h11fff



// Name:         X2P_START_PADDR_32_S0
// Default:      0x00010000 (X2P_START_PADDR_S0 & 0x00000000ffffffff)
...
`define X2P_START_PADDR_32_S0 32'h00010000


// Name:         X2P_END_PADDR_32_S0
// Default:      0x00010fff (X2P_END_PADDR_S0 & 0x00000000ffffffff)
...
`define X2P_END_PADDR_32_S0 32'h00010fff


// Name:         X2P_START_PADDR_32_S1
// Default:      0x00011000 (X2P_START_PADDR_S1 & 0x00000000ffffffff)
// Values:       0x00000000, ..., 0xfffffc00
// Enabled:      0
// 
...
// is non-editable and is used for visual purposes only 
// in the coreConsultant GUI.
`define X2P_START_PADDR_32_S1 32'h00011000


// Name:         X2P_END_PADDR_32_S1
// Default:      0x00011fff (X2P_END_PADDR_S1 & 0x00000000ffffffff)
// Values:       0x000003ff, ..., 0xffffffff
// Enabled:      0
// 
// End Address for APB Slave #1 that the component will use to decode the addressed APB Slave. This parameter is 
// non-editable and is used for visual purposes only in the coreConsultant GUI.
`define X2P_END_PADDR_32_S1 32'h00011fff
...
// Name:         X2P_HAS_APB3
// Default:      1 (X2P_IS_APB3_S0 || X2P_IS_APB3_S1 || X2P_IS_APB3_S2 || 
