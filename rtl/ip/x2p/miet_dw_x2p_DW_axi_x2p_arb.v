...
// Revision: $Id: //dwh/DW_ocb/DW_axi_x2p/amba_dev/src/DW_axi_x2p_arb.v#8 $ 
*/
//
//
...
module miet_dw_x2p_DW_axi_x2p_arb (/*AUTOARG*/
   // Outputs
...
parameter WREADY      = 3'b001;
parameter RREADY      = 3'b010; //2
parameter RREADY_PEND = 3'b100; //4
