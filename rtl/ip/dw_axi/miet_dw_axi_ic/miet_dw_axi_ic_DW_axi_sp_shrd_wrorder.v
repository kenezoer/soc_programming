...
module miet_dw_axi_ic_DW_axi_sp_shrd_wrorder (
  // Inputs - System
  aclk_i,
  aresetn_i,
...
//----------------------------------------------------------------------
  ...
  reg [`miet_dw_axi_ic_AXI_MAX_NUM_MST_SLVS-1:0] cpl_tx_bus_max;
  wire [`miet_dw_axi_ic_AXI_MAX_NUM_MST_SLVS-1:0] cpl_tx_bus_max_n;
  ...
  wire [`miet_dw_axi_ic_AXI_MAX_NUM_MST_SLVS-1:0] fifo_empty_bus_max;
  wire [`miet_dw_axi_ic_AXI_MAX_NUM_MST_SLVS-1:0] fifo_nxt_empty_bus_max;
  ...
  // 1 per system slave.
  reg [`miet_dw_axi_ic_AXI_MAX_NUM_MST_SLVS-1:0] issued_slvnum_max; 
  wire [`miet_dw_axi_ic_AXI_MAX_NUM_MST_SLVS-1:0] issued_slvnum_max_n;
  ...
  wire [`miet_dw_axi_ic_AXI_MAX_NUM_MST_SLVS-1:0] has_ddctd_w_s_max;
  ...
  always @(*) begin : issued_slvnum_max_PROC
    issued_slvnum_max = {`miet_dw_axi_ic_AXI_MAX_NUM_MST_SLVS{1'b0}};
  ...
  always @(*) begin : cpl_tx_bus_max_PROC
    cpl_tx_bus_max = {`miet_dw_axi_ic_AXI_MAX_NUM_MST_SLVS{1'b0}};
