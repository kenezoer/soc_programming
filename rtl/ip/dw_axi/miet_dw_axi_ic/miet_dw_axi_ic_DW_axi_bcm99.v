...
//
// Filename    : DW_axi_bcm99.v
// Revision    : $Id: //dwh/DW_ocb/DW_axi/amba_dev/src/DW_axi_bcm99.v#2 $
// Author      : Liming SU    06/19/15
// Description : DW_axi_bcm99.v Verilog module for DW_axi
//
// DesignWare IP ID: b4e548e6
//
////////////////////////////////////////////////////////////////////////////////

module miet_dw_axi_ic_DW_axi_bcm99 (
  clk_d,
  rst_d_n,
  data_s,
  data_d
...
// { START Latency Accurate modeling
  initial begin : set_setup_hold_delay_PROC
      `define miet_dw_axi_ic_DW_HOLD_MUX_DELAY  1
      if (ACCURATE_MISSAMPLING == 1)
        $display("Information: %m: *** Warning: `miet_dw_axi_ic_DW_HOLD_MUX_DELAY is not defined so it is being set to: %0d ***", `miet_dw_axi_ic_DW_HOLD_MUX_DELAY);

      `define miet_dw_axi_ic_DW_SETUP_MUX_DELAY  1
      if (ACCURATE_MISSAMPLING == 1)
        $display("Information: %m: *** Warning: `miet_dw_axi_ic_DW_SETUP_MUX_DELAY is not defined so it is being set to: %0d ***", `miet_dw_axi_ic_DW_SETUP_MUX_DELAY);
